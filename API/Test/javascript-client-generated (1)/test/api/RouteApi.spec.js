...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NordicRecipientAdminApp.RouteApi();
  });
  ...
  describe('RouteApi', function() {
    describe('findRoutes', function() {
      it('should call findRoutes successfully', function(done) {
        //uncomment below and update the code to test findRoutes
        //instance.findRoutes(function(error) {
